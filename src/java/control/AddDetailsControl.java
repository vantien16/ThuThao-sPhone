 ...
 * @author ADMIN
 */
@WebServlet(name = "AddDetailsControl", urlPatterns = {"/adddetails"})
public class AddDetailsControl extends HttpServlet {
...
//            System.out.println(quantity);
            ...
            if (!itemExists && a != null) {
                cartItems.add(a);
            }
//            cartItems.add(a);
            session.setAttribute("cartItems", cartItems);
            session.setMaxInactiveInterval(600);
            response.sendRedirect("MainControl?pid="+id+"&action=Details");
